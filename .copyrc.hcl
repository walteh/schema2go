copy {
	...
	options {
		...
		replacements = [
			...
			{
				old = "\"github.com/atombender/go-jsonschema/pkg/codegen\""
				new = "\"github.com/walteh/schema2go/pkg/reformat/codegen\""
			},
			{
				old = "Code generated by github.com/atombender/go-jsonschema"
				new = "Code generated by github.com/walteh/schema2go"
			},
		]
	}
}
