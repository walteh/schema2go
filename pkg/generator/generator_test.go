...
func runTestCase(t *testing.T, tc testCase) {
	...
	t.Run(tc.name, func(t *testing.T) {
		...
		// Clean both strings to avoid whitespace issues
		cleanExpected := strings.TrimSpace(tc.expectedOutput)
		cleanOutput := strings.TrimSpace(output)
		diffd := diff.TypedDiff(cleanExpected, cleanOutput)
		if diffd != "" {
			t.Logf("diff found: \n\n\n%s\n\n\n", diffd)
			require.Empty(t, diffd, "output does not match expected")
		}
	})
}
...
func (b *BasicExample) Validate() error {
	if b.ID == "" {
...
type Config_MixedArray struct {
	Referenced_OneOf *ReferencedType ` + "`json:\"referenced,omitempty\"`" + `
	Inline_OneOf *Config_MixedArray_Inline ` + "`json:\"inline,omitempty\"`" + `
}

type Config_MixedArray_Inline struct {
	Inline *string ` + "`json:\"inline,omitempty\"`" + `
}

func (o *Config_Inline_Value) UnmarshalJSON(data []byte) error {
	return nil // TODO: Implement
}

func (o Config_Inline_Value) MarshalJSON() ([]byte, error) {
	return nil, nil // TODO: Implement
}

func (o *ReferencedType_Value) UnmarshalJSON(data []byte) error {
	return nil // TODO: Implement
}

func (o ReferencedType_Value) MarshalJSON() ([]byte, error) {
	return nil, nil // TODO: Implement
}

func (o *Config_MixedArray) UnmarshalJSON(data []byte) error {
	return nil // TODO: Implement
}

func (o Config_MixedArray) MarshalJSON() ([]byte, error) {
	return nil, nil // TODO: Implement
}`,
	})
}

func TestSimpleAnyOfSchemaToStruct(t *testing.T) {
	runTestCase(t, testCase{
		name: "simple_anyof",
		input: `{
			"$schema": "http://json-schema.org/draft-07/schema#",
			...
			"properties": {
				"value": {
					...
					"description": "A simple anyOf example"
				}
			}
		}`,
		expectedOutput: `package models

// SimpleAnyOf represents a basic anyOf pattern example
type SimpleAnyOf struct {
	// A simple anyOf example
	Value SimpleAnyOf_Value ` + "`json:\"value,omitempty\"`" + `
}

type SimpleAnyOf_Value struct {
	StringValue_AnyOf  *string ` + "`json:\"string_value,omitempty\"`" + `
	IntegerValue_AnyOf *int    ` + "`json:\"integer_value,omitempty\"`" + `
}

func (a *SimpleAnyOf_Value) UnmarshalJSON(data []byte) error {
	return nil // TODO: Implement
}

func (a SimpleAnyOf_Value) MarshalJSON() ([]byte, error) {
	return nil, nil // TODO: Implement
}`,
	})
}
