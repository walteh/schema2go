...
//go:embed testcases/TestBasicSchemaToStruct.md
var TestBasicSchemaToStructCaseText string

func parseTestCase(text string) testCase {
	...
	input := text[jsonStart+7 : jsonStart+7+jsonEnd]
	...
	expectedOutput := text[goStart+5 : goStart+5+goEnd]
...
func TestBasicSchemaToStruct(t *testing.T) {
	runTestCase(t, parseTestCase(TestBasicSchemaToStructCaseText))
}
